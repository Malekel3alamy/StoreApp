...
class BestProductsAdapter:RecyclerView.Adapter<BestProductsAdapter.MyViewHolder>() {
    class MyViewHolder(private val binding: ProductRvItemBinding): RecyclerView.ViewHolder(binding.root) {
